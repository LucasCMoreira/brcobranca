    ...
    module Cnab240
      class Sicredi < Brcobranca::Remessa::Cnab240::Base
        ...
        def complemento_p(pagamento)
          ...
          var_nosso_numero_with_byte_idt = "#{Time.now.strftime('%y')}#{byte_idt}#{pagamento.nosso_numero}"
          ...
          "#{conta_corrente.rjust(12, '0')}#{digito_conta} #{var_nosso_numero.somente_numeros.ljust(20, ' ')}"
        end
